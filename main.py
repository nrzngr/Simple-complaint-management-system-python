...
root.title('Complaint Management by Kelompok ')
...
#Gridx1353
labels = ['Nama lengkap:', 'Gender:', 'Komplain:']
for i in range(3):
...
fullname.grid(row=0, column=1, columnspan=4)
SpanGender = StringVar()
Radiobutton(root, text='Pria', value='Pria', variable=SpanGender).grid(row=1, column=1)
Radiobutton(root, text='Wanita', value='Wanita', variable=SpanGender).grid(row=1, column=2)
